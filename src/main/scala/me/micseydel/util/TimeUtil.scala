...
object TimeUtil {
  ...
  val WithinDayHourMinute24HourDateTimeFormatter: DateTimeFormatter = DateTimeFormatter.ofPattern("HH:mm")
  val YearMonthDaySpaceTimeFormatter: DateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")
