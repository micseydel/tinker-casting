...
//object ExperimentalInsertionSortCellStateMachine {
//  // returns true if self wants to swap right
//  def apply(
////             maybeLeftValue: Option[Int],
//             selfValue: Int, maybeRightValue: Option[Int]): Boolean = {
//    (maybeLeftValue, maybeRightValue) match {
//      case (None, None) => ???
//      case (None, Some(justRightValue)) => ???
//      case (Some(justLeftValue), None) => ???
