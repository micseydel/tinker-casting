...
object SoundPlayerActor {
  ...
  def apply()(implicit Tinker: Tinker): Ability[Message] = AttentiveNoteMakingTinkerer[Message, ReceiveNotePing]("Sound Player", TinkerColor.random(), "🎙️", ReceiveNotePing) { (context, noteRef) =>
...
object SoundPlayerTestActor {
  ...
  def apply()(implicit Tinker: Tinker): Ability[Message] = AttentiveNoteMakingTinkerer[Message, ReceiveNotePing]("Sound Player Testing", TinkerColor.random(), "🥼", ReceiveNotePing) { (context, noteRef) =>
